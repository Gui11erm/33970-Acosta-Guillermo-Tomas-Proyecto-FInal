/* 
    ...
    FACTURAR A CLIENTES, Y OBTENER UN RESUMEN DE LAS OPERACIONES
...
const productoBaseDeDatos = [
    {
        nombreProducto:'ACTRON 600 X 20',
    ...
    {
        nombreProducto:'TAFIROL 1G X 80',
        laboratorio:'GENOMMA LAB',
...
class Producto {
    ...
    aplicarPrecio(){    // 30 % de ganancia + 21 % de IVA = 51%
